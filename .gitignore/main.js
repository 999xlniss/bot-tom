...
client.login('NTI4NjM5NDAwMzY4NjY4Njc2.DwlNiA.143VVHUw63vOAyRzzcvIZa-xjpc');
...
client.on('message', msg => {
    if (msg.content === ('qui est lpb ?'))
    msg.channel.sendMessage('Alnis bien sûr');
    console.log('Alnis lpb')
});

client.on('message', msg => {
    if (msg.content === ('qui est la plus moche ?'))
    msg.channel.sendMessage('christiane sans hésiter');
    console.log('christiane la moche')
});
